...
export function OnlineDashboardPage() {
  ...
  const hotPosts = useQuery({ queryKey: ['hot-posts'], queryFn: api.hotPosts, retry: false, staleTime: 60_000, refetchInterval: 5 * 60_000 })
  ...
  return <>
    ...
    <section className="mb-6 grid grid-cols-2 gap-3 xl:hidden" aria-label="在线快捷入口">
      <OnlineShortcut to="/posts?source=live" icon={Radio} title="最新树洞" note="公共时间线" />
